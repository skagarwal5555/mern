...
function Checkout() {
  ...
  let [userInfo, setUserInfo] = useState({
    ...
    address: {
      streetAddress:
        state.profile.address !== undefined
          ? state.profile.address.streetAddress
          : "",
      city:
        state.profile.address !== undefined ? state.profile.address.city : "",
      state:
        state.profile.address !== undefined ? state.profile.address.state : "",
      zipCode:
        state.profile.address !== undefined
          ? state.profile.address.zipCode
          : "",
    },
  });
